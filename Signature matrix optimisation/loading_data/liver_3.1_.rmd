#cholangiocarcinoma dataset 3.1
...
counts <- Read10X_h5("loading_data/single_cell_data/CHOL_GSE125449_aPD1aPDL1aCTLA4_expression.h5")

## metadata
l <- read_tsv("loading_data/single_cell_data/CHOL_GSE125449_aPD1aPDL1aCTLA4_CellMetainfo_table.tsv")
...
```{r}
set.seed(999)
bulk_liver_3.1 = make_bulk_eset(eset=exp,
                           cell_fractions = cell_fractions,
                           n=500)
fData(bulk_liver_3.1) = rownames_to_column(fData(bulk_liver_3.1),var = "gene_symbol")

saveRDS(bulk_liver_3.1,"loading_data/pseudobulk_data/bulk_liver_3.1.rds")


bulk_liver_3.1_txt = as.data.frame(exprs(bulk_liver_3.1))%>%
 rownames_to_column("Gene")


write.table(bulk_liver_3.1_txt, sep = '\t', "bulk_liver_3.1.txt", row.names = FALSE, quote = FALSE, col.names = TRUE)
