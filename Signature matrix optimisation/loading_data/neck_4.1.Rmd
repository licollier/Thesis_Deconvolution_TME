...
counts <- Read10X_h5("loading_data/single_cell_data/HNSC_GSE103322_expression.h5")

## metadata
l <- read_tsv("loading_data/single_cell_data/HNSC_GSE103322_CellMetainfo_table.tsv")
...
```{r}
set.seed(999)
bulk_neck_4.1 = make_bulk_eset(eset=exp,
                           cell_fractions = cell_fractions,
                           n=500)
fData(bulk_neck_4.1) = rownames_to_column(fData(bulk_neck_4.1),var = "gene_symbol")

saveRDS(bulk_neck_4.1,"loading_data/pseudobulk_data/bulk_neck_4.1.rds")


bulk_neck_4.1_txt = as.data.frame(exprs(bulk_neck_4.1))%>%
 rownames_to_column("Gene")


write.table(bulk_neck_4.1_txt, sep = '\t', "bulk_neck_4.1.txt", row.names = FALSE, quote = FALSE, col.names = TRUE)
